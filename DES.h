...
static int shiftTable[] = { 1, 1, 2, 2, 2, 2, 2, 2, 1, 2, 2, 2, 2, 2, 2, 1 };
...
static void generateRoundKeys(string key, string* roundKeys) {
...
static string manglerFunction(string right, string roundKey) {
...
static string desEncrypt(string plaintext, string key) {
    string roundKeys[16];
